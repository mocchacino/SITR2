...
<script>
	...
	$(document).ready(function(){
		...
		$('#print').click(function(){
			...
			var kopsurat = '<body><h2 style="text-align:center;">DAFTAR MAHASISWA TUGAS RISET II<br>DEPARTEMEN KIMIA FAKULTAS SAINS DAN MATEMATIKA<br>UNIVERSITAS DIPONEGORO SEMARANG</h2><hr><hr><br>';
			...
			<div class="panel-body ">
				...
				<div class="printArea">
					<table id ="myTable" class="display printArea" style="width: 100%">
						...
						$show_pendaftar = "SELECT * FROM daftar_tugas_riset2 INNER JOIN mahasiswa on mahasiswa.nim=daftar_tugas_riset2.nim inner join tr1 on tr1.nim=daftar_tugas_riset2.nim inner join lab on lab.idlab =tr1.idlab_tr1 where tahun_ajaran='".$rPeriodeSekarang['periode_sekarang']."' ORDER BY daftar_tugas_riset2.nim";
							...
							echo '<h2 align="center">Daftar Mahasiswa Tugas Riset 2 Tahun ';
							for ($i=0; $i <9 ; $i++) { 
