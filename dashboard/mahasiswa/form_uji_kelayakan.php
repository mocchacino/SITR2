<?php   
  ...
  if (!isset($_SESSION['sip_masuk_aja'])){
    ...
    $retrieve_info = mysqli_query($con, "SELECT * from mahasiswa inner join daftar_uji_kelayakan on mahasiswa.nim=daftar_uji_kelayakan.nim inner join daftar_tugas_riset2 on mahasiswa.nim=daftar_tugas_riset2.nim where mahasiswa.nim='$nim' ");
  ...
  <body>
    ...
    <table>
      ...
      echo '<tr>';
        ...
        echo '<td>:</td>';
        echo '<td>'.$fretrieve_info->jadwal.'</td>';
        echo '<td></td>';
      echo'</tr>';
      echo '<tr>';
        echo '<td>TEMPAT</td>';
      ...
      echo '<tr>';
        ...
        echo '<td>:</td>';
        echo '<td>'.$fretrieve_info->judul.'</td>';
        echo '<td></td>';
      echo'</tr>';
      echo '<tr>';
      ...
      echo '<tr>';
        if(!$rnama_pembimbing2){
          ...
          echo "<td></td>";
          echo "<td></td>";
          echo"<td class='numerasi'> 2. ".$rnama_pembimbing2->nama_dosen."</td>";
          echo "<td></td>"; 
        } 
      echo'</tr>';
      echo '<tr>';
