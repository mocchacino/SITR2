...
<?php
				echo "<a href='download_transkrip_uji_kelayakan.php?file=".$rshow_detail['path_file']."' class='btn btn-primary pull-right'>Download Transkrip</a>";
?>
				</div>
...
<?php
								$show_penguji = mysqli_query($con,"SELECT nama_dosen FROM dosen inner join penguji_kelayakan on penguji_kelayakan.nip_penguji_kelayakan=dosen.nip inner join uji_kelayakan on uji_kelayakan.id_uji_kelayakan=penguji_kelayakan.id_uji_kelayakan where uji_kelayakan.nim= '".$nim."' and jabatan='penguji' and uji_kelayakan.id_uji_kelayakan='".$rshow_detail_uji_kelayakan['id_uji_kelayakan']."' ");
								$no_penguji=1;
...
?>
					...
					<?php echo '<a href="edit_mahasiswa_uji_kelayakan.php?nim='.$nim.'&id='.$id.'" class="btn btn-primary btn-sm pull-right"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>';?>
							</form>
						</div>
					</div>
				</div>
