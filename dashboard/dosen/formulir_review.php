<?php
	...
	if (!isset($_SESSION['sip_masuk_aja'])){
		...
		if($_SERVER['REQUEST_METHOD']==='GET'){				
				...
				$pembimbing3=mysqli_query($con, "SELECT nama, nip from pembimbing_luar where nip='".$rDataMahasiswa['nip3']."' ");
...
?>
						...
						<h2 class="margin_top"><center><b>SIDANG UJIAN SKRIPSI<br>PROGRAM STUDI S1 KIMIA<br>DEPARTEMEN KIMIA<br>FAKULTAS SAINS DAN MATEMATIKA<br>UNIVERSITAS DIPONEGORO SEMARANG</b></center></h2>
						<hr><hr>
