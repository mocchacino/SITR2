	...
	if (!isset($_SESSION['sip_masuk_aja'])){
		...
		if ($_SERVER['REQUEST_METHOD'] === 'GET'){
			...
			if (isset($_POST['submit'])) {
				...
				$nilai_pembimbing_skripsi3=test_input($_POST['nilai_pembimbing_skripsi3']);
				...
				if(($counter==$validNilai)&&($counter==$jml_penguji)){
					...
					$ubah_is_lulus=mysqli_query($con, "UPDATE uji_skripsi set is_lulus='".$is_lulus."', is_test='sudah' where id_uji_skripsi='".$id."'");
						$ubah_is_lulus_daftar_skripsi=mysqli_query($con, "UPDATE daftar_skripsi set is_lulus='".$is_lulus."', tgl_lulus='".$tgl_lulus."' where id_daftar_skripsi='".$id."'");
					if($tambah_nilai && $ubah_is_lulus && $ubah_is_lulus_daftar_skripsi && $ubah_is_lulus && $tambah_nilai && $ubah_is_lulus_daftar_skripsi){
						$sukses=true;
...
?>
								...
								<div class="row">
									<div class="form-group col-md-8 col-sm-8 col-xs-12">
										<label>Pembimbing 3</label>&nbsp;<span class="label label-warning">*<?php if(isset($error_nilai_pembimbing_skripsi3)) echo $error_nilai_pembimbing_skripsi3;?></span>
										<input class="form-control" name="pembimbing_skripsi3" id="pembimbing_skripsi3" readonly>
									</div>
									<div class="form-group col-md-4 col-sm-4 col-xs-12">
										<label>Nilai</label>&nbsp;
										<input class="form-control" name="nilai_pembimbing_skripsi3" id="nilai_pembimbing_skripsi3">
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-8 col-sm-8 col-xs-12">
