			...
			<div class="panel-body ">
				...
				<div class="printArea">
					<table id ="myTable" class="display printArea" style="width: 100%">
						...
						<tbody width='100%'>
<?php	
						$show_pendaftar=mysqli_query($con,"SELECT distinct mahasiswa.nim, mahasiswa.nama, judul, jadwal, tempat from uji_skripsi inner join mahasiswa on mahasiswa.nim=uji_skripsi.nim inner join daftar_skripsi on daftar_skripsi.id_daftar_skripsi=uji_skripsi.id_uji_skripsi where( jadwal is not null and tahun_ajaran='$rPeriodeSekarang->periode_sekarang') and (nip1='$nip_saya') order by jadwal desc ");
						$no=1;
