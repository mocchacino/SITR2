		...
		if ($_SERVER['REQUEST_METHOD'] === 'POST') {
			if (isset($_POST['edit'])) {
				...
				if(($counter==$validNilai)&&($counter==$jml_penguji)){
					...
					$ubah_is_lulus=mysqli_query($con, "UPDATE uji_skripsi set is_lulus='".$is_lulus."' where id_uji_skripsi='".$id."'");
...
?>
								...
								<div class="form-group">
									<label>NIM</label>&nbsp;
									<input class="form-control" type='text' id='nim' name="nim" readonly autofocus">
								</div>
								<input type="text" name="nipPembimbing1" id="nipPembimbing1" hidden>
								<input type="text" name="nipPembimbing2" id="nipPembimbing2" hidden>
								<input type="text" name="nipPembimbing3" id="nipPembimbing3" hidden>
