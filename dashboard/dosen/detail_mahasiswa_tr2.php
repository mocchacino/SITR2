...
<html>
<head>
	<title>Detail Mahasiswa Tugas Riset 2</title>
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					Detail Mahasiswa Tugas Riset 2
<?php
					echo '<a href="download_transkrip_tr2.php?file='.$rshow_detail['path_file'].'" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Download Transkrip</a>';
?>
				</div>
						...
						<div class="col-md-12">
							<form>
								...
								<div class="row">
									...
									<div class="form-group col-md-4 col-sm-4 col-xs-12">
										<label>Tanggal Daftar Daftar TR 2</label>&nbsp;
									</div>
								...
								<div class="row">
									<div class="form-group col-md-3 col-sm-3 col-xs-12">
										<label>Semester pada saat Pendaftaran</label>&nbsp;
									</div>
									<div class="form-group col-md-3 col-sm-3 col-xs-12">
									...
									<div class="form-group col-md-3 col-sm-3 col-xs-12">
										<label>Jumlah IPK saat Pendaftaran</label>&nbsp;
									</div>
								</div>
								<div class="row">
									<div class="form-group col-md-3 col-sm-3 col-xs-12">
										<input class="form-control" name="semester" id="semester" value="<?php echo $rshow_detail['semester'];?>" readonly>
									</div>
									<div class="form-group col-md-3 col-sm-3 col-xs-12">
									...
									<div class="form-group col-md-3 col-sm-3 col-xs-12">
										<input class="form-control" name="ipk" id="ipk" value="<?php echo $rshow_detail['ipk'];?>" readonly>
									</div>
								</div>
							</form>
						</div>
