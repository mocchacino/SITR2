...
?>
						...
						<h3 class="margin_top"><center><b>LEMBAR PENILAIAN SIDANG TUGAS RISET<br>PROGRAM STUDI S1 DEPARTEMEN KIMIA FAKULTAS SAINS DAN MATEMATIKA<br>UNIVERSITAS DIPONEGORO SEMARANG</b></center></h3>
						<hr><hr>
...
// SKRIPSI
						echo '<tr style="font-weight:bold;">';
						echo '<td colspan="4">I. Skripsi (40%)</td>';
						echo '</tr>';
...
// PRESENTASI
						echo '<tr style="font-weight:bold;">';
						echo '<td colspan="4">II. Presentasi (10%)</td>';
						echo '</tr>';

						echo '<tr>';
						echo '<td>3. Penyajian, Penggunaan Media, dan Ketepatan Waktu (1-100)</td>';
						echo '<td>10%</td>';
						echo '<td>10% x .....</td>';
						echo '<td>.....</td>';
						echo '</tr>';
...
// DISKUSI
						...
						echo '<tr>';
						echo '<td>4. Penguasaan Materi (1-100)</td>';
						echo '<td>10%</td>';
						echo '<td>10% x .....</td>';
						echo '<td>.....</td>';
						echo '</tr>';
						...
						echo '<tr>';
						echo '<td>5. Kemampuan Analisis (1-100)</td>';
						echo '<td>10%</td>';
						echo '<td>10% x .....</td>';
						echo '<td>.....</td>';
						echo '</tr>';
						...
						echo '<tr>';
						echo '<td>6. Penguasaan Pengetahuan Penunjang (1-100)</td>';
						echo '<td>10%</td>';
						echo '<td>10% x .....</td>';
						echo '<td>.....</td>';
						echo '</tr>';
...
//TANDA TANGAN
						...
						echo '<tr>';
						echo '<td >Panitia Ujian Sidang</td>';
						echo '<td ></td>';
