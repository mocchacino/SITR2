<?php	
	...
	if (!isset($_SESSION['sip_masuk_aja'])){
		...
		$dari_tgl='';
		$sampai_tgl='';
		$periodeTersedia=mysqli_query($con, "SELECT distinct tahun_ajaran from daftar_uji_kelayakan order by tahun_ajaran desc");
			...
			<div class="col-md-2 col-sm-12 col-xs-12">
				<div class="form-group">
					...
					<!-- <a href="daftar_uji_kelayakan.php">
					 ...
					 -->
					 <input class="form-control btn btn-danger" type="button" name="reset" value="Reset" onclick="window.location.href='lab_daftar_uji_kelayakan.php'" />
						...
						if(isset($_POST['search_tgl'])) {
							if(empty($dari_tgl) && empty($sampai_tgl)){
								if($periode=='-Pilih Periode-'){
									$show_pendaftar="SELECT DISTINCT mahasiswa.nim, mahasiswa.nama, daftar_tugas_riset2.judul, daftar_tugas_riset2.nip1, daftar_tugas_riset2.nip2, daftar_tugas_riset2.nip3, jadwal, tempat,daftar_uji_kelayakan.tahun_ajaran,id_daftar_uji_kelayakan from daftar_uji_kelayakan inner join uji_kelayakan on uji_kelayakan.id_uji_kelayakan=daftar_uji_kelayakan.id_daftar_uji_kelayakan inner join mahasiswa on mahasiswa.nim=daftar_uji_kelayakan.nim inner join daftar_tugas_riset2 on daftar_tugas_riset2.nim=daftar_uji_kelayakan.nim ";
								}else{
									$show_pendaftar = "SELECT DISTINCT mahasiswa.nim, mahasiswa.nama, daftar_tugas_riset2.judul, daftar_tugas_riset2.nip1, daftar_tugas_riset2.nip2, daftar_tugas_riset2.nip3, jadwal, tempat,daftar_uji_kelayakan.tahun_ajaran,id_daftar_uji_kelayakan from daftar_uji_kelayakan inner join uji_kelayakan on uji_kelayakan.id_uji_kelayakan=daftar_uji_kelayakan.id_daftar_uji_kelayakan inner join mahasiswa on mahasiswa.nim=daftar_uji_kelayakan.nim inner join daftar_tugas_riset2 on daftar_tugas_riset2.nim=daftar_uji_kelayakan.nim where daftar_uji_kelayakan.tahun_ajaran='$periode' ";
								}
							}else{
								$show_pendaftar = "SELECT DISTINCT mahasiswa.nim, mahasiswa.nama, daftar_tugas_riset2.judul, daftar_tugas_riset2.nip1, daftar_tugas_riset2.nip2, daftar_tugas_riset2.nip3, jadwal, tempat,daftar_uji_kelayakan.tahun_ajaran,id_daftar_uji_kelayakan from daftar_uji_kelayakan inner join uji_kelayakan on uji_kelayakan.id_uji_kelayakan=daftar_uji_kelayakan.id_daftar_uji_kelayakan inner join mahasiswa on mahasiswa.nim=daftar_uji_kelayakan.nim inner join daftar_tugas_riset2 on daftar_tugas_riset2.nim=daftar_uji_kelayakan.nim where (uji_kelayakan.jadwal BETWEEN '$dari_tgl' AND '$sampai_tgl') GROUP by id_uji_kelayakan";
							}
						}else{
							...
							while($rshow_pendaftar = $fshow_pendaftar->fetch_object()){
								...
								$nama_penguji="SELECT * FROM dosen inner join penguji_kelayakan on penguji_kelayakan.nip_penguji_kelayakan=dosen.nip WHERE id_uji_kelayakan='$rshow_pendaftar->id_daftar_uji_kelayakan' ";
								$fnama_penguji=$con->query($nama_penguji);
								$jml_penguji=mysqli_num_rows($fnama_penguji);
								$no_urut=1;
								echo "<td>";
								...
								if($jml_penguji==0){
									echo "<a href='daftar_penguji_kelayakan.php?nim=".$rshow_pendaftar->nim."&id=".$rshow_pendaftar->id_daftar_uji_kelayakan."' title='Jadwal & Penguji'><i class='fa fa-plus'></i></a>&nbsp;";
								}
								echo "<a href='berita_acara_ujian_sarjana.php?nim=".$rshow_pendaftar->nim."&id=".$rshow_pendaftar->id_daftar_uji_kelayakan."' title='Berita Acara'><i class='fa fa-print'></i></a>&nbsp;
									<a 
										data-toggle='modal' 
										data-target='#myModal' 
