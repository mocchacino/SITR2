...
<html>
<head>
	<title>Berita Acara Seminar Kelayakan Skripsi</title>	
	<style>
		th, td {
		    padding: 5px;
		}
...
if($jml_rInfoUjiKelayakan==0){
	...
	echo'<div class="col-md-12 col-sm-12 col-xs-12">';
		...
		echo '<a href="admin_daftar_uji_kelayakan.php" class="btn btn-primary"><i class="fa fa-chevron-circle-left"></i> Kembali</a>';
	echo '</div></div></div></div>';
}else{
	echo'<div class="well clearfix">';
	echo'<div class="col-md-12 col-sm-12 col-xs-12">';
		echo'<div class="form-group">';
			echo '<a href="print_lab.php?nim='.$get_nim.'&id='.$id.'"" class="btn btn-primary"><i class="fa fa-chevron-circle-left"></i> Kembali</a>';
...
<?php
	...
	for($halaman=1;$halaman<3;$halaman++) {
		...
		echo '</tr>';
		echo '</table><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
		echo '<table align="left" style="font-size:10pt" width="100%">';
			echo '<tr>';
