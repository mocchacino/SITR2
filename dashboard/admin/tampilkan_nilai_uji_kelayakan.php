		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<a href="daftar_nilai_uji_kelayakan.php" class="btn btn-primary"><i class="fa fa-chevron-circle-left"></i> Kembali</a>
					Detail Nilai Mahasiswa
<?php
								
					echo '<a href="edit_nilai_uji_kelayakan.php?nim='.$nim.'&id='.$id.'" class="btn btn-primary btn-sm pull-right"><i class="fa fa-pencil-square-o"></i> Edit Nilai</a>';
