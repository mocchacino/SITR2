...
<script>
	...
	$(document).ready(function(){
		...
		$('#print').click(function(){
			...
			var kopsurat = '<body><h1 style="text-align:center;">DAFTAR ADMIN<br>DEPARTEMEN KIMIA FAKULTAS SAINS DAN MATEMATIKA<br>UNIVERSITAS DIPONEGORO SEMARANG</h1><hr><hr><br><script type="text/javascript" src="https://code.jquery.com/jquery-3.3.1.min.js"><\/script>';
			...
			<div class="panel-body ">
				...
				<div class="printArea">
					<table id ="myTable" class="display" style="width: 100%">
						...
						<?php	
						$i=1;
						$showAdmin = mysqli_query($con,"SELECT * from petugas order by idpetugas");
							while($rshowAdmin = $showAdmin->fetch_object()){
								echo "<tr>";
								echo "<td align='center'>".$i."</td>";$i++;
								echo "<td>".$rshowAdmin->nama."</td>";
								echo "<td>".$rshowAdmin->email."</td>";
								echo "<td class='tools' id='tools' align='center'>
									<a data-toggle='modal' 
										data-target='#repass' 
										data-email='".$rshowAdmin->email."'
										title='Reset Password'
										class='button_reset'><i class='fa fa-key'></i></a>
									<a href='edit_admin.php?nip=".$rshowAdmin->idpetugas."' title='Edit'><i class='fa fa-pencil-square-o'></i></a>
									<a data-toggle='modal' 
										data-target='#myModal' 
										data-email='".$rshowAdmin->email."'
										title='Hapus'
...
<div class="modal-dialog modal-md">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <p>Apakah anda yakin untuk menghapus data Admin?</p>
...
<script type="text/javascript">
	$('.button_hapus').click(function(){
		...
		$('#hapus_idpetugas').html('E-mail : '+ $(this).data('email'));
	});
