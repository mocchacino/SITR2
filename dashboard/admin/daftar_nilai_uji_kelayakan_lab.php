	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="panel panel-default">
			<div class="row panel-heading" style="margin: 0;">
			   ...
			   Daftar Nilai Mahasiswa Laboratorium 
<?php
						...
						if(isset($_POST['search_tgl'])) {
							...
							while($rshow_pendaftar = $fshow_pendaftar->fetch_object()){
								...
								echo "<td id='tools' align='center'>
									<a href='tampilkan_nilai_uji_kelayakan_lab.php?nim=".$rshow_pendaftar->nim."&id=".$rshow_pendaftar->id_uji_kelayakan."'><i class='fa fa-eye'></i> Tampilkan Nilai</a>
								 </td>";
