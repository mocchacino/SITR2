<?php
	...
	if(isset($_POST['submit'])){
		...
		if ($validjadwal_buka && $validjadwal_tutup && $validmin_ipk) {
			...
			$insert_jadwal=mysqli_query($con,"UPDATE waktu SET awal='$jadwal_buka', akhir='$jadwal_tutup', syarat_ipk='$min_ipk' where nama='TR2' ");
			if (!$insert_jadwal) {
...
<html>
<head>
	<title>Jadwal Pendaftaran Tugas Riset 2</title>
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				Jadwal Pendaftaran Tugas Riset 2
			</div>
