<?php
	...
	if (!isset($_SESSION['sip_masuk_aja'])){
		...
		if($_SERVER['REQUEST_METHOD']==='GET'){				
				...
				$pembimbing3=mysqli_query($con, "SELECT nip, nama_dosen from dosen where nip='".$rDataMahasiswa['nip3']."' ");
		            ...
		            <body>
		              <div class="panel-body">
		                  ...
		                  <div class="panel-body"><div class="well clearfix">
		                  	<?php
		                  	echo '<a href="print_lab_admin.php?nim='.$nim.'&id='.$id.'" class="btn btn-primary"><i class="fa fa-chevron-circle-left"></i> Kembali ke Daftar Print</a>';
		                  	?>
...
//TANDA TANGAN
					...
					for($jml=1; $jml<4;$jml++){
						if(${"rPembimbing".$jml}['nama_dosen']!=''){
							echo '<h3 class="margin_top"><center><b>LEMBAR PENILAIAN SEMINAR KELAYAKAN SKRIPSI<br>PROGRAM S1 DEPARTEMEN KIMIA FAKULTAS SAINS DAN MATEMATIKA<br>UNIVERSITAS DIPONEGORO SEMARANG</b></center></h3>
							<hr><hr>
			                <div class="isisurat">';
