		              ...
		              $(document).ready(function(){
		                  $('#print').click(function(){
		                    ...
		                    var htmlToPrint = '' +
		                      ...
		                      htmlToPrint = divToPrint.outerHTML;
		                    var win = window.open();
		                    win.document.write('<style>div.margin{width: 21cm;min-height: 29.7cm;padding: 2cm; margin: 1cm auto;} .ttd{padding:0 0 0 175px; width:50%;} .pengisi{width:25%;} table.isi{line-height: 50px; font-size: 18px} .footer_surat{font-size:10px; position:fixed; bottom:50; width: 21cm;} </style>');
