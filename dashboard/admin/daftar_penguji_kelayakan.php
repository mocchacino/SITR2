					...
					if(($counter==$validPenguji) && $validTempat && $validJadwal && $validNim){
						if($rCek->jml !=0){
							...
							for($j=1;$j<=$counter;$j++){
								...
								$tambahPenguji=mysqli_query($con, "INSERT into penguji_kelayakan (id_uji_kelayakan, nip_penguji_kelayakan) values ('".$id."', '".$penguji."')");
							}
							$sukses=true;
	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<a href="admin_daftar_uji_kelayakan.php" class="btn btn-primary"><i class="fa fa-chevron-circle-left"></i> Kembali </a> Edit Penguji dari Laboratorium
			</div>
...
?> 
							...
							<div class="form-group">
								...
								<datalist id="tempat">
									<option></option>
									<option value='Laboratorium Biokimia'>
									<option value='Laboratorium Kimia Anorganik'>
									<option value='Laboratorium Kimia Organik'>
...
<!-- <script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('.input_nip').change(function(){
			if($(".input_nip").val()==undefined){
				var nip="";
			}else{
				var nip= $(".input_nip").val();
			}
