	...
	if (!isset($_SESSION['sip_masuk_aja'])){
		...
		if(!isset($_POST['edit'])){
			if ($_SERVER['REQUEST_METHOD']==='GET'){
				...
				$show_detail=mysqli_query($con, "SELECT daftar_uji_kelayakan.*, mahasiswa.nama, daftar_tugas_riset2.nip1,daftar_tugas_riset2.nip2,daftar_tugas_riset2.nip3,daftar_tugas_riset2.judul FROM daftar_uji_kelayakan inner join daftar_tugas_riset2 on daftar_tugas_riset2.nim=daftar_uji_kelayakan.nim INNER JOIN mahasiswa on mahasiswa.nim=daftar_tugas_riset2.nim where daftar_tugas_riset2.nim='$nim' and id_daftar_uji_kelayakan='$id' ORDER BY daftar_tugas_riset2.tgl_daftar ");	
...
<html>
<head>
	<title>Edit Mahasiswa Uji Kelayakan</title>
