<?php
	...
	if(isset($_POST['submit'])){
		...
		if ($validjadwal_buka && $validjadwal_tutup && $validmin_ipk) {
			...
			$insert_jadwal=mysqli_query($con,"UPDATE waktu SET awal='$jadwal_buka', akhir='$jadwal_tutup', syarat_ipk='$min_ipk' where nama='Skr' ");
			if (!$insert_jadwal) {
...
<html>
<head>
	<title>Jadwal Pendaftaran Skripsi</title>
