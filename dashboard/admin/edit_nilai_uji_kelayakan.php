<?php		
	...
	if (!isset($_SESSION['sip_masuk_aja'])){
		...
		if ($_SERVER['REQUEST_METHOD']==='GET'){
			$nim=$_GET['nim'];
			$id=$_GET['id'];
			$show_nim_pendaftar_uji_kelayakan=mysqli_query($con, "SELECT uji_kelayakan.nim FROM uji_kelayakan inner join tr1 on tr1.nim=uji_kelayakan.nim where uji_kelayakan.is_lulus='0' and uji_kelayakan.id_uji_kelayakan='$id' ");
		}
		...
		$(document).ready(function(){
			$('#input_id').ready(function(){
				...
				$.ajax({
				    type: "POST",
				    data: 'id='+id,
					url:"autopopulate_edit_nilai_uji_kelayakan.php",
					dataType:"json",
					cache: false,
