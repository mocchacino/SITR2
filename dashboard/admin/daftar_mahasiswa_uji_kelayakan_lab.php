	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="panel panel-default">
			<div class="row panel-heading" style="margin: 0;">
			   ...
			   Daftar Mahasiswa yang mendaftar Uji Kelayakan Laboratorium
<?php
				echo $_SESSION['admin_sebagai_lab'];
?>
			...
			<div class="col-md-2 col-sm-12 col-xs-12">
				<div class="form-group">
					...
					<!-- <a href="daftar_uji_kelayakan.php">
					 ...
					 -->
					 <input class="form-control btn btn-danger" type="button" name="reset" value="Reset" onclick="window.location.href='daftar_mahasiswa_uji_kelayakan_lab.php'" />
					...
					<table id ="myTable" class="display printArea" style="width: 100%">
						...
						if(isset($_POST['search_tgl'])) {
							if(empty($dari_tgl) && empty($sampai_tgl)){
								...
								$show_pendaftar = "SELECT DISTINCT mahasiswa.nim, mahasiswa.nama, daftar_tugas_riset2.judul, daftar_tugas_riset2.nip1, daftar_tugas_riset2.nip2, daftar_tugas_riset2.nip3, jadwal, tempat,daftar_uji_kelayakan.tahun_ajaran,id_daftar_uji_kelayakan from daftar_uji_kelayakan inner join uji_kelayakan on uji_kelayakan.id_uji_kelayakan=daftar_uji_kelayakan.id_daftar_uji_kelayakan inner join mahasiswa on mahasiswa.nim=daftar_uji_kelayakan.nim inner join daftar_tugas_riset2 on daftar_tugas_riset2.nim=daftar_uji_kelayakan.nim inner join tr1 on tr1.nim=daftar_tugas_riset2.nim where tr1.idlab_tr1='$idlab' and (uji_kelayakan.jadwal BETWEEN '$dari_tgl' AND '$sampai_tgl') GROUP by id_uji_kelayakan";
							}
						}else{
							...
							while($rshow_pendaftar = $fshow_pendaftar->fetch_object()){
								...
								echo "<a href='edit_mahasiswa_uji_kelayakan_lab.php?nim=".$rshow_pendaftar->nim."&id=".$rshow_pendaftar->id_daftar_uji_kelayakan."' title='Ubah Mahasiswa Uji Kelayakan'><i class='fa fa-edit'></i></a>&nbsp;

									<a href='print_lab.php?nim=".$rshow_pendaftar->nim."&id=".$rshow_pendaftar->id_daftar_uji_kelayakan."' title='Cetak berkas'><i class='fa fa-print'></i></a>&nbsp;
									<a 
										data-toggle='modal' 
										data-target='#myModal' 
